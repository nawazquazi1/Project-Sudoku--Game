 ...
 * All of these words mean: "something (a file in this case) which describes one or more objects
 ...
 * 
 * If I was to describe that contract/interface/protocol/abstraction (English unfortunately has many words
 * for one thing) in Java code, it look like:
 * 
...
public interface IUserInterfaceContract {
	...
	// Short is just smaller version of an "int". Although computers have become very powerful,
	// it is still good practice to use the smallest possible data structure, unless legibility
	// (such as an enum) is a more important concern for the problem in front of you.
	interface EventListener {
		void onSudokuInput(int x, int y, int input);
		void onDialogClick();
	}
	
	// View refers to what the user can "View", or "See". In English, the word is both a noun and verb.
	interface View {
