...
/**
 * Remember, a program contains representations of real world objects (i.e. Money, User, Game).
 * These things contain real world information (although they may also contain useless/stub/test
 * information), and are necessary for a program which does anything practical.
 *
...
public class SudokuGame implements Serializable {
	...
	/**
     * To make it easier to work with Arrays (where the first index position is 0 instead of 1,
     * and so on), Grid coordinates will be represented with x and y index values ranging from
     * 0 (inclusive) to 8 (inclusive).
     */
